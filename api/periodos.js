...
export const getPeriodos = async () => {
    try{
        const response = await api.get('https://tp2024-2.onrender.com/periodo-escolar')
        
        return response.data;

    } catch (error) {
        console.error('Error al ver periodo')
        throw error;
    }};
...
//     export const getsSeccionById = async (seccion_id) => {
//         try {
